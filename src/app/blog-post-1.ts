...
export const post = `<blog-content>
  ...
  <blog-code highlightLines="4-7">function filterByLegCount(array, legCount) {
  ...
  filterByLegCount(
    ...
    <blog-text>
      There are many different terms being used that all try to differentiate between different kinds 
      of components. Some have the same meaning, <blog-inline-code>Test</blog-inline-code> I've got the feeling that every other developer 
      has a little different view on their intended behavior. Let’s gather the terms:
    </blog-text>
